...
const Pricing = () => {
  ...
  <div className="card-body space-y-4">
    ...
    <div className="mt-6">
      <button className="btn bg-violet-600 btn-block rounded-full text-white">Get Started Free</button>
    </div>
  </div>
            </div>
  ...
  <div className="card-body text-white relative">
    ...
    <div className="mt-6">
      <button className="btn btn-block rounded-full bg-white text-violet-500">Start Pro Trial</button>
    </div>
  </div>
            </div>
  ...
  <div className="card-body">
    ...
    <div className="mt-6">
      <button className="btn bg-violet-600 btn-block rounded-full text-white">Contact Sales</button>
    </div>
  </div>
            </div>
        </div>
